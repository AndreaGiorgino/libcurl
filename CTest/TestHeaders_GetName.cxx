...
auto TestHeaders_GetName(int, char**) -> int {
    helpers::checkeq(libcurl::getHeaderName(headers::WWW_AUTHENTICATE),
                     "WWW-Authenticate");
    helpers::checkeq(libcurl::getHeaderName(headers::AUTHORIZATION),
                     "Authorization");
    ...
    helpers::checkeq(libcurl::getHeaderName(headers::CACHE_CONTROL),
                     "Cache-Control");
    helpers::checkeq(libcurl::getHeaderName(headers::CLEAR_SITE_DATA),
                     "Clear-Site-Data");
    helpers::checkeq(libcurl::getHeaderName(headers::EXPIRES), "Expires");
    helpers::checkeq(libcurl::getHeaderName(headers::LAST_MODIFIED),
                     "Last-Modified");
    helpers::checkeq(libcurl::getHeaderName(headers::ETAG), "ETag");
    helpers::checkeq(libcurl::getHeaderName(headers::IF_MATCH), "If-Match");
    helpers::checkeq(libcurl::getHeaderName(headers::IF_NONE_MATCH),
                     "If-None-Match");
    ...
    helpers::checkeq(libcurl::getHeaderName(headers::ACCEPT_ENCODING),
                     "Accept-Encoding");
    helpers::checkeq(libcurl::getHeaderName(headers::ACCEPT_LANGUAGE),
                     "Accept-Language");
    helpers::checkeq(libcurl::getHeaderName(headers::ACCEPT_PATCH),
                     "Accept-Patch");
    helpers::checkeq(libcurl::getHeaderName(headers::ACCEPT_POST),
                     "Accept-Post");
    helpers::checkeq(libcurl::getHeaderName(headers::EXPECT), "Expect");
    helpers::checkeq(libcurl::getHeaderName(headers::MAX_FORWARDS),
                     "Max-Forwards");
    ...
    helpers::checkeq(libcurl::getHeaderName(headers::CONTENT_DISPOSITION),
                     "Content-Disposition");
    helpers::checkeq(libcurl::getHeaderName(headers::INTEGRITY_POLICY),
                     "Integrity-Policy");
    helpers::checkeq(
        libcurl::getHeaderName(headers::INTEGRITY_POLICY_REPORT_ONLY),
        "Integrity-Policy-Report-Only");
    helpers::checkeq(libcurl::getHeaderName(headers::CONTENT_LENGTH),
                     "Content-Length");
    helpers::checkeq(libcurl::getHeaderName(headers::CONTENT_TYPE),
                     "Content-Type");
    helpers::checkeq(libcurl::getHeaderName(headers::CONTENT_ENCODING),
                     "Content-Encoding");
    helpers::checkeq(libcurl::getHeaderName(headers::CONTENT_LANGUAGE),
                     "Content-Language");
    helpers::checkeq(libcurl::getHeaderName(headers::CONTENT_LOCATION),
                     "Content-Location");
    ...
    helpers::checkeq(libcurl::getHeaderName(headers::REFERRER_POLICY),
                     "Referrer-Policy");
    ...
    helpers::checkeq(libcurl::getHeaderName(headers::X_FRAME_OPTIONS),
                     "X-Frame-Options");
    helpers::checkeq(
        libcurl::getHeaderName(headers::X_PERMITTED_CROSS_DOMAIN_POLICIES),
        "X-Permitted-Cross-Domain-Policies");
    helpers::checkeq(libcurl::getHeaderName(headers::X_POWERED_BY),
                     "X-Powered-By");
    helpers::checkeq(libcurl::getHeaderName(headers::X_XSS_PROTECTION),
                     "X-XSS-Protection");
    helpers::checkeq(libcurl::getHeaderName(headers::SEC_FETCH_SITE),
                     "Sec-Fetch-Site");
    helpers::checkeq(libcurl::getHeaderName(headers::SEC_FETCH_MODE),
                     "Sec-Fetch-Mode");
    helpers::checkeq(libcurl::getHeaderName(headers::SEC_FETCH_USER),
                     "Sec-Fetch-User");
    helpers::checkeq(libcurl::getHeaderName(headers::SEC_FETCH_DEST),
                     "Sec-Fetch-Dest");
    helpers::checkeq(libcurl::getHeaderName(headers::SEC_PURPOSE),
                     "Sec-Purpose");
    helpers::checkeq(
    ...
    helpers::checkeq(libcurl::getHeaderName(headers::RETRY_AFTER),
                     "Retry-After");
    helpers::checkeq(libcurl::getHeaderName(headers::SERVER_TIMING),
                     "Server-Timing");
    helpers::checkeq(libcurl::getHeaderName(headers::SERVICE_WORKER),
                     "Service-Worker");
    ...
    helpers::checkeq(libcurl::getHeaderName((headers)999),
                     "Not-Standard-999");
